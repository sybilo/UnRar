...
public class SaltAccess {
    ...
    public SaltAccess(String password) {
        this.password = password;
    }

    public int readFully(byte[] buffer, int count, IReadFully irf) throws IOException {
